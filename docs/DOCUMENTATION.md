...
Понял, выдача была оборвана. Продолжаю в формате Markdown, как требуется. Ниже даю **дополнительные разделы** (11–18) для вставки в вашу документацию `DOCUMENTATION.md`, а затем — **презентацию на 8 слайдов**.
